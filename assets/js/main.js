...
(function() {
  ...
  /**
   * Mobile nav + dropdown toggles (delegated so dynamically injected nav works)
   */
  ...
  if (navMenuEl) {
    navMenuEl.addEventListener('click', function(e) {
      ...
      if (toggle) {
        ...
        const sibling = toggle.parentNode.nextElementSibling;
        if (sibling) {
  ...
  document.querySelectorAll('.isotope-layout').forEach(function(isotopeItem) {
    if (isotopeItem.getAttribute('data-dynamic-portfolio') === 'true') {
      return;
    }
